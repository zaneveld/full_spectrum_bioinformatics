...
- **Chapter 5. Project Design**
     ...
     - **Dr. Mushtaq Bilal**: [Zotero for Beginners (a.k.a How to Avoid Repeatedly Reformatting 96 Citations by Hand)](./content/05_project_design/zotero.ipynb) [![Open in nbviewer](assets/nbviewer_badge.svg)](https://nbviewer.jupyter.org/github/zaneveld/full_spectrum_bioinformatics/blob/master/content/05_project_design/zotero.ipynb)
